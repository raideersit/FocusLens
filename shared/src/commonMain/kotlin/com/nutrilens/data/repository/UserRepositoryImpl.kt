...
import com.nutrilens.domain.exceptions.EmailAlreadyExistsException
import com.nutrilens.domain.exceptions.InvalidCredentialsException
...
import com.nutrilens.platform.randomUUID
import com.nutrilens.platform.sha256
 ...
 */
private fun com.nutrilens.db.UserEntity.toDomain() = User(
    id        = id,
    name      = name,
    email     = email,
    createdAt = createdAt,
